#!/usr/bin/python3
"""
Script that takes an integer n as the input and
returns an integer as the output.
"""


def minOperations(n):
    """Calculates the minimum number of operations to get n
    H characters in a file.

    The only operations allowed are Copy All and Paste.
    The file initially contains one H character.
    ...
    Returns:
      ...
      or 0 if n is not a positive integer.
    """
